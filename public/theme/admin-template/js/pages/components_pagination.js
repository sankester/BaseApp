...
$(function() {
    ...
    $('.bootpag-default').bootpag({
        ...
        leaps: false
            ...
            $(".content-default").html("PageLib " + num); // or some ajax content loading...
    ...
    $('.bootpag-flat').bootpag({
        ...
        leaps: false
            ...
            $(".content-flat").html("PageLib " + num); // or some ajax content loading...
    ...
    $('.bootpag-separated').bootpag({
        ...
        leaps: false
            ...
            $(".content-separated").html("PageLib " + num); // or some ajax content loading...
    ...
    $('.bootpag-prev-next').bootpag({
        ...
        next: 'next'
            ...
            $(".content-prev-next").html("PageLib " + num); // or some ajax content loading...
    }).children('.pagination').addClass('pagination-flat pagination-sm');
    ...
    $('.bootpag-page-start').bootpag({
        ...
        leaps: false
            ...
            $(".content-page-start").html("PageLib " + num); // or some ajax content loading...
    }).children('.pagination').addClass('pagination-flat pagination-sm');
    ...
    $('.bootpag-callback').bootpag({
        ...
        leaps: false
            ...
            $(".content-callback").html("PageLib " + num); // or some ajax content loading...
    ...
    $('.twbs-default').twbsPagination({
        ...
        onPageClick: function (event, page) {
            $('.twbs-content-default').text('PageLib ' + page);
        }
    });
    ...
    $('.twbs-flat').twbsPagination({
        ...
        last: null,
        onPageClick: function (event, page) {
            $('.twbs-content-flat').text('PageLib ' + page);
        }
    });
    ...
    $('.twbs-separated').twbsPagination({
        ...
        last: null,
        onPageClick: function (event, page) {
            $('.twbs-content-separated').text('PageLib ' + page);
        }
    });
    ...
    $('.twbs-prev-next').twbsPagination({
        ...
        last: '&#8677;',
        onPageClick: function (event, page) {
            $('.twbs-content-prev-next').text('PageLib ' + page);
        }
    });
    ...
    $('.twbs-page-start').twbsPagination({
        ...
        last: null,
        onPageClick: function (event, page) {
            $('.twbs-content-page-start').text('PageLib ' + page);
        }
    });
    ...
    $('.twbs-visible-pages').twbsPagination({
        ...
        last: null,
        onPageClick: function (event, page) {
            $('.twbs-content-visible-pages').text('PageLib ' + page);
        }
    });
