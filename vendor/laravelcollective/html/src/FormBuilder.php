...
class FormBuilder
{
     ...
     */
    public function open(array $options = [], array $attribute = [])
    {
     ...
     * @return \Illuminate\Support\HtmlString
     */
    public function model($model, array $options = [], array $attributes = [])
    {
        $this->model = $model;

        return $this->open($options, $attributes);
    }
